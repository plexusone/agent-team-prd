module github.com/plexusone/agent-team-prd
...
replace (
	github.com/inconshreveable/log15/v3 => github.com/inconshreveable/log15/v3 v3.0.0-testing.5
	golang.ngrok.com/ngrok => golang.ngrok.com/ngrok v1.12.0
)
