...
- [mcpkit](https://github.com/plexusone/mcpkit) for MCP server runtime
...
```bash
go install github.com/plexusone/agent-team-prd/cmd/prdtool@v0.1.0
go install github.com/plexusone/agent-team-prd/cmd/prdtool-mcp@v0.1.0
```
...
- github.com/plexusone/mcpkit v0.3.1
...
- [GitHub Repository](https://github.com/plexusone/agent-team-prd)
